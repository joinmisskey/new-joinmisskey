...
export const repositories = ['misskey-dev/misskey', 'mei23/misskey', 'TeamBlackCrystal/misskey', 'mei23/misskey-v11', 'Groundpolis/Groundpolis', 'kokonect-link/cherrypick'] as const;
